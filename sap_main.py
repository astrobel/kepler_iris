...
### DOING SAP - note: NOT saving as FITS to save disk space
...
print(f'{kic} files and dat but no figure')
...
#     # amplitude spectrum
#     ft.loglog(freqs, ampls, 'k-', lw=0.5) # overall rms divided by point to point rms - or other way around?
#     ft.set_xlim(0.1, 283)
